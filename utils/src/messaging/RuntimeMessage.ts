/**
 * The message sender and recipient identifiers.
 */
export type MessageAddress = 'background' | 'content' | 'popup' | 'options';
...
export type RuntimeMessage = RequestMessage | ResponseMessage;
